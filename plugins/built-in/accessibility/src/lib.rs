...
pub extern "C" fn nebula_plugin_execute(
    ...
    let result = match action {
        "isEnabled" => {
            invoke(ctx, "android:accessibility:isAccessibilityEnabled", "{}")
        }
        "getScreenContent" => {
            invoke(ctx, "android:accessibility:getScreenContent", "{}")
        }
        "performClick" => {
        ...
        "getClipboard" => {
            invoke(ctx, "android:clipboard:getClipboard", "{}")
        }
        "setClipboard" => {
        ...
        "listInstalledApps" => {
            invoke(ctx, "android:apps:listInstalledApps", "{}")
        }
        "launchApp" => {
