...
pub mod ai_home_state {
    ...
    pub struct AiHomeOption {
        ...
        pub image_background_color: ::core::option::Option<::prost::alloc::string::String>,
    }
...
pub struct BotAgeCollectionMetadata {
    ...
    #[prost(enumeration="bot_age_collection_metadata::AgeCollectionType", optional, tag="3")]
...
pub mod bot_capability_metadata {
    ...
    pub enum BotCapabilityType {
        ...
        RichResponseUrZeitgeistCitations = 50,
        RichResponseUrZeitgeistCarousel = 51,
        AiImagineLoadingIndicator = 52,
        RichResponseUrImagine = 53,
        AiImagineUrToNativeLoadingIndicator = 54,
    }
    impl BotCapabilityType {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::RichResponseUnifiedTextComponent => "RICH_RESPONSE_UNIFIED_TEXT_COMPONENT",
                Self::AiSharedMemory => "AI_SHARED_MEMORY",
                Self::RichResponseUnifiedSources => "RICH_RESPONSE_UNIFIED_SOURCES",
                Self::RichResponseUnifiedDomainCitations => "RICH_RESPONSE_UNIFIED_DOMAIN_CITATIONS",
                Self::RichResponseUrInlineReelsEnabled => "RICH_RESPONSE_UR_INLINE_REELS_ENABLED",
                Self::RichResponseUrMediaGridEnabled => "RICH_RESPONSE_UR_MEDIA_GRID_ENABLED",
                Self::RichResponseUrTimestampPlaceholder => "RICH_RESPONSE_UR_TIMESTAMP_PLACEHOLDER",
                Self::RichResponseInAppSurvey => "RICH_RESPONSE_IN_APP_SURVEY",
                Self::AiResponseModelBranding => "AI_RESPONSE_MODEL_BRANDING",
                Self::SessionTransparencySystemMessage => "SESSION_TRANSPARENCY_SYSTEM_MESSAGE",
                Self::RichResponseUrReasoning => "RICH_RESPONSE_UR_REASONING",
                Self::RichResponseUrZeitgeistCitations => "RICH_RESPONSE_UR_ZEITGEIST_CITATIONS",
                Self::RichResponseUrZeitgeistCarousel => "RICH_RESPONSE_UR_ZEITGEIST_CAROUSEL",
                Self::AiImagineLoadingIndicator => "AI_IMAGINE_LOADING_INDICATOR",
                Self::RichResponseUrImagine => "RICH_RESPONSE_UR_IMAGINE",
                Self::AiImagineUrToNativeLoadingIndicator => "AI_IMAGINE_UR_TO_NATIVE_LOADING_INDICATOR",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "RICH_RESPONSE_SOURCES_IN_MESSAGE" => Some(Self::RichResponseSourcesInMessage),
                "RICH_RESPONSE_SIDE_BY_SIDE_SURVEY" => Some(Self::RichResponseSideBySideSurvey),
                "RICH_RESPONSE_UNIFIED_TEXT_COMPONENT" => Some(Self::RichResponseUnifiedTextComponent),
                "AI_SHARED_MEMORY" => Some(Self::AiSharedMemory),
                "RICH_RESPONSE_UNIFIED_SOURCES" => Some(Self::RichResponseUnifiedSources),
                "RICH_RESPONSE_UNIFIED_DOMAIN_CITATIONS" => Some(Self::RichResponseUnifiedDomainCitations),
                "RICH_RESPONSE_UR_INLINE_REELS_ENABLED" => Some(Self::RichResponseUrInlineReelsEnabled),
                "RICH_RESPONSE_UR_MEDIA_GRID_ENABLED" => Some(Self::RichResponseUrMediaGridEnabled),
                "RICH_RESPONSE_UR_TIMESTAMP_PLACEHOLDER" => Some(Self::RichResponseUrTimestampPlaceholder),
                ...
                "SESSION_TRANSPARENCY_SYSTEM_MESSAGE" => Some(Self::SessionTransparencySystemMessage),
                "RICH_RESPONSE_UR_REASONING" => Some(Self::RichResponseUrReasoning),
                "RICH_RESPONSE_UR_ZEITGEIST_CITATIONS" => Some(Self::RichResponseUrZeitgeistCitations),
                "RICH_RESPONSE_UR_ZEITGEIST_CAROUSEL" => Some(Self::RichResponseUrZeitgeistCarousel),
                "AI_IMAGINE_LOADING_INDICATOR" => Some(Self::AiImagineLoadingIndicator),
                "RICH_RESPONSE_UR_IMAGINE" => Some(Self::RichResponseUrImagine),
                "AI_IMAGINE_UR_TO_NATIVE_LOADING_INDICATOR" => Some(Self::AiImagineUrToNativeLoadingIndicator),
                _ => None,
            }
        }
    }
...
/// Nested message and enum types in `BotDocumentMessageMetadata`.
    ...
    impl DocumentPluginType {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::OcrAndImages => "OCR_AND_IMAGES",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "OCR_AND_IMAGES" => Some(Self::OcrAndImages),
                _ => None,
            }
        }
    }
...
pub struct BotFeedbackMessage {
    ...
    #[prost(message, optional, tag="7")]
    pub side_by_side_survey_metadata: ::core::option::Option<bot_feedback_message::SideBySideSurveyMetadata>,
}
...
pub mod bot_feedback_message {
    ...
    pub struct SideBySideSurveyMetadata {
        ...
        #[prost(string, optional, tag="5")]
        pub response_timestamp_ms_string: ::core::option::Option<::prost::alloc::string::String>,
        #[prost(bool, optional, tag="6")]
        ...
        #[prost(message, optional, tag="8")]
        pub analytics_data: ::core::option::Option<side_by_side_survey_metadata::SideBySideSurveyAnalyticsData>,
        #[prost(message, optional, tag="9")]
        pub meta_ai_analytics_data: ::core::option::Option<side_by_side_survey_metadata::SidebySideSurveyMetaAiAnalyticsData>,
    }
    ...
    pub mod side_by_side_survey_metadata {
        ...
        pub struct SideBySideSurveyAnalyticsData {
            ...
            #[prost(string, optional, tag="2")]
            pub tessa_session_fbid: ::core::option::Option<::prost::alloc::string::String>,
            #[prost(string, optional, tag="3")]
            pub simon_session_fbid: ::core::option::Option<::prost::alloc::string::String>,
        }
        #[derive(serde::Serialize, serde::Deserialize)]
        ...
        pub struct SidebySideSurveyMetaAiAnalyticsData {
            ...
            #[prost(string, optional, tag="4")]
            pub timestamp_ms_string: ::core::option::Option<::prost::alloc::string::String>,
            #[prost(message, optional, tag="5")]
            pub cta_impression_event: ::core::option::Option<sideby_side_survey_meta_ai_analytics_data::SideBySideSurveyCtaImpressionEventData>,
            #[prost(message, optional, tag="6")]
            pub cta_click_event: ::core::option::Option<sideby_side_survey_meta_ai_analytics_data::SideBySideSurveyCtaClickEventData>,
            #[prost(message, optional, tag="7")]
            pub card_impression_event: ::core::option::Option<sideby_side_survey_meta_ai_analytics_data::SideBySideSurveyCardImpressionEventData>,
            #[prost(message, optional, tag="8")]
            pub response_event: ::core::option::Option<sideby_side_survey_meta_ai_analytics_data::SideBySideSurveyResponseEventData>,
            #[prost(message, optional, tag="9")]
            pub abandon_event: ::core::option::Option<sideby_side_survey_meta_ai_analytics_data::SideBySideSurveyAbandonEventData>,
        }
        ...
        pub mod sideby_side_survey_meta_ai_analytics_data {
            ...
            pub struct SideBySideSurveyAbandonEventData {
                #[prost(string, optional, tag="1")]
                pub abandon_dwell_time_ms_string: ::core::option::Option<::prost::alloc::string::String>,
            }
            #[derive(serde::Serialize, serde::Deserialize)]
            #[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
            pub struct SideBySideSurveyCtaClickEventData {
                ...
                #[prost(string, optional, tag="2")]
                pub click_dwell_time_ms_string: ::core::option::Option<::prost::alloc::string::String>,
            }
            #[derive(serde::Serialize, serde::Deserialize)]
            #[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
            ...
            pub struct SideBySideSurveyResponseEventData {
                #[prost(string, optional, tag="1")]
                pub response_dwell_time_ms_string: ::core::option::Option<::prost::alloc::string::String>,
                #[prost(string, optional, tag="2")]
                pub selected_response_id: ::core::option::Option<::prost::alloc::string::String>,
            }
        }
    }
    #[derive(serde::Serialize, serde::Deserialize)]
    ...
    impl BotFeedbackKind {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::BotFeedbackNegativeHallucinationInternalOnly => "BOT_FEEDBACK_NEGATIVE_HALLUCINATION_INTERNAL_ONLY",
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "BOT_FEEDBACK_NEGATIVE_HALLUCINATION_INTERNAL_ONLY" => Some(Self::BotFeedbackNegativeHallucinationInternalOnly),
...
pub struct BotGroupMetadata {
    #[prost(message, repeated, tag="1")]
    pub participants_metadata: ::prost::alloc::vec::Vec<BotGroupParticipantMetadata>,
}
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct BotGroupParticipantMetadata {
    #[prost(string, optional, tag="1")]
    pub bot_fbid: ::core::option::Option<::prost::alloc::string::String>,
}
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
...
pub struct BotMetadata {
    ...
    pub conversation_starter_prompt_id: ::core::option::Option<::prost::alloc::string::String>,
    ...
    pub session_transparency_metadata: ::core::option::Option<SessionTransparencyMetadata>,
    #[prost(message, optional, tag="34")]
    pub bot_document_message_metadata: ::core::option::Option<BotDocumentMessageMetadata>,
    #[prost(message, optional, tag="35")]
    pub bot_group_metadata: ::core::option::Option<BotGroupMetadata>,
    #[prost(message, optional, tag="36")]
    pub bot_rendering_config_metadata: ::core::option::Option<BotRenderingConfigMetadata>,
    #[prost(bytes="vec", optional, tag="999")]
    pub internal_metadata: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
}
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
pub struct BotProgressIndicatorMetadata {
    ...
    #[prost(int64, optional, tag="3")]
    pub estimated_completion_time: ::core::option::Option<i64>,
}
...
pub struct BotRenderingConfigMetadata {
    #[prost(string, optional, tag="1")]
    pub bloks_versioning_id: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(double, optional, tag="2")]
    pub pixel_density: ::core::option::Option<f64>,
}
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct BotSignatureVerificationUseCaseProof {
    ...
    #[prost(enumeration="bot_signature_verification_use_case_proof::BotSignatureUseCase", optional, tag="2")]
...
pub struct BotUnifiedResponseMutation {
    #[prost(message, optional, tag="1")]
    pub sbs_metadata: ::core::option::Option<bot_unified_response_mutation::SideBySideMetadata>,
    #[prost(message, repeated, tag="2")]
    pub media_details_metadata_list: ::prost::alloc::vec::Vec<bot_unified_response_mutation::MediaDetailsMetadata>,
}
...
pub struct ClientPairingProps {
    ...
    #[prost(bool, optional, tag="4")]
    pub is_hs_thumbnail_sync_enabled: ::core::option::Option<bool>,
}
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
pub mod client_payload {
        ...
        impl DnsResolutionMethod {
            ...
            pub fn as_str_name(&self) -> &'static str {
                match self {
                    ...
                    Self::Mns => "MNS",
                    Self::MnsSecondary => "MNS_SECONDARY",
                    Self::SocksProxy => "SOCKS_PROXY",
                }
            }
            /// Creates an enum from field names used in the ProtoBuf definition.
            pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
                match value {
                    ...
                    "MNS" => Some(Self::Mns),
                    "MNS_SECONDARY" => Some(Self::MnsSecondary),
                    "SOCKS_PROXY" => Some(Self::SocksProxy),
                    _ => None,
                }
            }
        }
    ...
    pub struct WebInfo {
        ...
        #[prost(string, optional, tag="6")]
        pub browser_version: ::core::option::Option<::prost::alloc::string::String>,
    }
...
pub struct ContextInfo {
    ...
    pub question_reply_quoted_message: ::core::option::Option<::prost::alloc::boxed::Box<context_info::QuestionReplyQuotedMessage>>,
    #[prost(message, optional, tag="69")]
    pub status_audience_metadata: ::core::option::Option<context_info::StatusAudienceMetadata>,
...
pub mod context_info {
    ...
    pub struct QuestionReplyQuotedMessage {
        ...
        #[prost(message, optional, boxed, tag="2")]
        pub quoted_question: ::core::option::Option<::prost::alloc::boxed::Box<super::Message>>,
        #[prost(message, optional, boxed, tag="3")]
        pub quoted_response: ::core::option::Option<::prost::alloc::boxed::Box<super::Message>>,
    }
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
...
pub mod conversation {
    ...
    pub enum EndOfHistoryTransferType {
        ...
        CompleteOnDemandSyncWithMoreMsgOnPrimaryButNoAccess = 3,
    }
    impl EndOfHistoryTransferType {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::CompleteOnDemandSyncWithMoreMsgOnPrimaryButNoAccess => "COMPLETE_ON_DEMAND_SYNC_WITH_MORE_MSG_ON_PRIMARY_BUT_NO_ACCESS",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "COMPLETE_ON_DEMAND_SYNC_WITH_MORE_MSG_ON_PRIMARY_BUT_NO_ACCESS" => Some(Self::CompleteOnDemandSyncWithMoreMsgOnPrimaryButNoAccess),
                _ => None,
            }
        }
    }
...
pub struct DeviceCapabilities {
    ...
    #[prost(message, optional, tag="3")]
    pub business_broadcast: ::core::option::Option<device_capabilities::BusinessBroadcast>,
    #[prost(message, optional, tag="4")]
    pub user_has_avatar: ::core::option::Option<device_capabilities::UserHasAvatar>,
    #[prost(enumeration="device_capabilities::MemberNameTagPrimarySupport", optional, tag="5")]
    pub member_name_tag_primary_support: ::core::option::Option<i32>,
    #[prost(message, optional, tag="6")]
    pub ai_thread: ::core::option::Option<device_capabilities::AiThread>,
}
...
pub mod device_capabilities {
    ...
    pub struct AiThread {
        ...
        pub support_level: ::core::option::Option<i32>,
    }
    /// Nested message and enum types in `AiThread`.
    pub mod ai_thread {
        #[derive(serde::Serialize, serde::Deserialize)]
        #[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
        #[repr(i32)]
...
pub struct GroupHistoryBundleInfo {
    #[prost(message, optional, tag="1")]
    pub deprecated_message_history_bundle: ::core::option::Option<message::MessageHistoryBundle>,
    #[prost(enumeration="group_history_bundle_info::ProcessState", optional, tag="2")]
...
pub mod handshake_message {
    ...
    pub struct ClientFinish {
        ...
        #[prost(bytes="vec", optional, tag="3")]
        pub extended_ciphertext: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
    }
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
    ...
    pub struct ServerHello {
        ...
        pub payload: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
        #[prost(bytes="vec", optional, tag="4")]
        pub extended_static: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
    }
}
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct InThreadSurveyMetadata {
    ...
    #[prost(message, repeated, tag="12")]
    pub questions: ::prost::alloc::vec::Vec<in_thread_survey_metadata::InThreadSurveyQuestion>,
    #[prost(string, optional, tag="13")]
    pub survey_continue_button_text: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(string, optional, tag="14")]
    pub survey_submit_button_text: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(string, optional, tag="15")]
    pub privacy_statement_full: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(message, repeated, tag="16")]
    pub privacy_statement_parts: ::prost::alloc::vec::Vec<in_thread_survey_metadata::InThreadSurveyPrivacyStatementPart>,
    #[prost(string, optional, tag="17")]
    pub feedback_toast_text: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(int32, optional, tag="18")]
    pub start_question_index: ::core::option::Option<i32>,
}
...
pub struct Message {
    ...
    pub newsletter_follower_invite_message_v2: ::core::option::Option<::prost::alloc::boxed::Box<message::NewsletterFollowerInviteMessage>>,
    #[prost(message, optional, boxed, tag="115")]
    pub poll_result_snapshot_message_v3: ::core::option::Option<::prost::alloc::boxed::Box<message::PollResultSnapshotMessage>>,
    #[prost(message, optional, boxed, tag="116")]
    pub newsletter_admin_profile_message: ::core::option::Option<::prost::alloc::boxed::Box<message::FutureProofMessage>>,
}
...
pub mod message {
    ...
    pub struct Call {
        ...
        pub context_info: ::core::option::Option<::prost::alloc::boxed::Box<super::ContextInfo>>,
        #[prost(string, optional, tag="8")]
        pub native_flow_call_button_payload: ::core::option::Option<::prost::alloc::string::String>,
        #[prost(string, optional, tag="9")]
        pub deeplink_payload: ::core::option::Option<::prost::alloc::string::String>,
        #[prost(message, optional, tag="10")]
        pub message_context_info: ::core::option::Option<super::MessageContextInfo>,
    }
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Clone, PartialEq, ::prost::Message)]
    ...
    pub struct HistorySyncNotification {
        ...
        #[prost(message, optional, tag="15")]
        pub message_access_status: ::core::option::Option<HistorySyncMessageAccessStatus>,
    }
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Clone, PartialEq, ::prost::Message)]
    ...
    pub struct InteractiveMessage {
        ...
        #[prost(message, optional, boxed, tag="3")]
        pub footer: ::core::option::Option<::prost::alloc::boxed::Box<interactive_message::Footer>>,
    ...
    pub mod interactive_message {
        ...
        pub struct CarouselMessage {
            ...
            #[prost(enumeration="carousel_message::CarouselCardType", optional, tag="3")]
    ...
    pub struct LinkPreviewMetadata {
        ...
        #[prost(enumeration="link_preview_metadata::SocialMediaPostType", optional, tag="5")]
        ...
        pub music_metadata: ::core::option::Option<super::EmbeddedMusic>,
        #[prost(string, optional, tag="9")]
        pub video_content_caption: ::core::option::Option<::prost::alloc::string::String>,
    }
    ...
    pub struct PeerDataOperationRequestMessage {
        ...
        #[prost(message, optional, tag="8")]
        pub history_sync_chunk_retry_request: ::core::option::Option<peer_data_operation_request_message::HistorySyncChunkRetryRequest>,
        #[prost(message, optional, tag="9")]
        pub galaxy_flow_action: ::core::option::Option<peer_data_operation_request_message::GalaxyFlowAction>,
    }
    ...
    pub mod peer_data_operation_request_message {
        ...
        pub struct HistorySyncChunkRetryRequest {
            ...
            pub chunk_order: ::core::option::Option<u32>,
            #[prost(string, optional, tag="3")]
            pub chunk_notification_id: ::core::option::Option<::prost::alloc::string::String>,
            #[prost(bool, optional, tag="4")]
    ...
    pub mod peer_data_operation_request_response_message {
        ...
        pub struct PeerDataOperationResult {
            ...
            #[prost(message, optional, tag="9")]
            pub companion_canonical_user_nonce_fetch_request_response: ::core::option::Option<peer_data_operation_result::CompanionCanonicalUserNonceFetchResponse>,
            #[prost(message, optional, tag="10")]
            pub history_sync_chunk_retry_response: ::core::option::Option<peer_data_operation_result::HistorySyncChunkRetryResponse>,
        }
        ...
        pub mod peer_data_operation_result {
            ...
            pub struct HistorySyncChunkRetryResponse {
                ...
                #[prost(string, optional, tag="3")]
                pub request_id: ::core::option::Option<::prost::alloc::string::String>,
                #[prost(enumeration="HistorySyncChunkRetryResponseCode", optional, tag="4")]
                pub response_code: ::core::option::Option<i32>,
                #[prost(bool, optional, tag="5")]
            ...
            pub struct LinkPreviewResponse {
                ...
                #[prost(message, optional, tag="9")]
                pub preview_metadata: ::core::option::Option<link_preview_response::PaymentLinkPreviewMetadata>,
            }
        ...
        impl StatusNotificationType {
            ...
            pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
                match value {
                    ...
                    "STATUS_QUESTION_ANSWER_RESHARE" => Some(Self::StatusQuestionAnswerReshare),
                    _ => None,
                }
            }
        }
    ...
    pub struct StatusStickerInteractionMessage {
        ...
        #[prost(enumeration="status_sticker_interaction_message::StatusStickerType", optional, tag="3")]
        pub r#type: ::core::option::Option<i32>,
    }
    ...
    impl PeerDataOperationRequestType {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::CompanionCanonicalUserNonceFetch => "COMPANION_CANONICAL_USER_NONCE_FETCH",
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "COMPANION_CANONICAL_USER_NONCE_FETCH" => Some(Self::CompanionCanonicalUserNonceFetch),
...
pub struct QuarantinedMessage {
    #[prost(bytes="vec", optional, tag="1")]
    pub original_data: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
    #[prost(string, optional, tag="2")]
...
pub struct SyncActionValue {
    ...
    pub privacy_setting_channels_personalised_recommendation_action: ::core::option::Option<sync_action_value::PrivacySettingChannelsPersonalisedRecommendationAction>,
    #[prost(message, optional, tag="66")]
    pub detected_outcomes_status_action: ::core::option::Option<sync_action_value::DetectedOutcomesStatusAction>,
    #[prost(message, optional, tag="68")]
    pub maiba_ai_features_control_action: ::core::option::Option<sync_action_value::MaibaAiFeaturesControlAction>,
    #[prost(message, optional, tag="69")]
    pub business_broadcast_list_action: ::core::option::Option<sync_action_value::BusinessBroadcastListAction>,
    #[prost(message, optional, tag="70")]
    pub music_user_id_action: ::core::option::Option<sync_action_value::MusicUserIdAction>,
    #[prost(message, optional, tag="71")]
    pub status_post_opt_in_notification_preferences_action: ::core::option::Option<sync_action_value::StatusPostOptInNotificationPreferencesAction>,
    #[prost(message, optional, tag="72")]
    pub avatar_updated_action: ::core::option::Option<sync_action_value::AvatarUpdatedAction>,
    #[prost(message, optional, tag="74")]
    pub private_processing_setting_action: ::core::option::Option<sync_action_value::PrivateProcessingSettingAction>,
    #[prost(message, optional, tag="75")]
    pub newsletter_saved_interests_action: ::core::option::Option<sync_action_value::NewsletterSavedInterestsAction>,
    #[prost(message, optional, tag="76")]
    pub ai_thread_rename_action: ::core::option::Option<sync_action_value::AiThreadRenameAction>,
    #[prost(message, optional, tag="77")]
    pub interactive_message_action: ::core::option::Option<sync_action_value::InteractiveMessageAction>,
    #[prost(message, optional, tag="78")]
    pub settings_sync_action: ::core::option::Option<sync_action_value::SettingsSyncAction>,
}
...
pub mod sync_action_value {
    ...
    pub struct MusicUserIdAction {
        ...
        pub music_user_id_map: ::std::collections::HashMap<::prost::alloc::string::String, ::prost::alloc::string::String>,
    }
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
    ...
    pub struct NewsletterSavedInterestsAction {
        #[prost(string, optional, tag="1")]
        pub newsletter_saved_interests: ::core::option::Option<::prost::alloc::string::String>,
    }
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
    ...
    pub struct SettingsSyncAction {
        #[prost(bool, optional, tag="1")]
        pub start_at_login: ::core::option::Option<bool>,
        #[prost(bool, optional, tag="2")]
        pub minimize_to_tray: ::core::option::Option<bool>,
        #[prost(string, optional, tag="3")]
        pub language: ::core::option::Option<::prost::alloc::string::String>,
        #[prost(bool, optional, tag="4")]
        pub replace_text_with_emoji: ::core::option::Option<bool>,
        #[prost(enumeration="settings_sync_action::DisplayMode", optional, tag="5")]
        pub banner_notification_display_mode: ::core::option::Option<i32>,
        #[prost(enumeration="settings_sync_action::DisplayMode", optional, tag="6")]
        pub unread_counter_badge_display_mode: ::core::option::Option<i32>,
        #[prost(bool, optional, tag="7")]
        pub is_messages_notification_enabled: ::core::option::Option<bool>,
        #[prost(bool, optional, tag="8")]
        pub is_calls_notification_enabled: ::core::option::Option<bool>,
        #[prost(bool, optional, tag="9")]
        pub is_reactions_notification_enabled: ::core::option::Option<bool>,
        #[prost(bool, optional, tag="10")]
        pub is_status_reactions_notification_enabled: ::core::option::Option<bool>,
        #[prost(bool, optional, tag="11")]
        pub is_text_preview_for_notification_enabled: ::core::option::Option<bool>,
        #[prost(int32, optional, tag="12")]
        pub default_notification_tone_id: ::core::option::Option<i32>,
        #[prost(int32, optional, tag="13")]
        pub group_default_notification_tone_id: ::core::option::Option<i32>,
        #[prost(int32, optional, tag="14")]
        pub app_theme: ::core::option::Option<i32>,
        #[prost(int32, optional, tag="15")]
        pub wallpaper_id: ::core::option::Option<i32>,
        #[prost(bool, optional, tag="16")]
        pub is_doodle_wallpaper_enabled: ::core::option::Option<bool>,
        #[prost(int32, optional, tag="17")]
        pub font_size: ::core::option::Option<i32>,
        #[prost(bool, optional, tag="18")]
        pub is_photos_autodownload_enabled: ::core::option::Option<bool>,
        #[prost(bool, optional, tag="19")]
        pub is_audios_autodownload_enabled: ::core::option::Option<bool>,
        #[prost(bool, optional, tag="20")]
        pub is_videos_autodownload_enabled: ::core::option::Option<bool>,
        #[prost(bool, optional, tag="21")]
        pub is_documents_autodownload_enabled: ::core::option::Option<bool>,
        #[prost(bool, optional, tag="22")]
        pub disable_link_previews: ::core::option::Option<bool>,
        #[prost(int32, optional, tag="23")]
        pub notification_tone_id: ::core::option::Option<i32>,
    }
    /// Nested message and enum types in `SettingsSyncAction`.
    pub mod settings_sync_action {
        ...
        impl DisplayMode {
            ...
            pub fn as_str_name(&self) -> &'static str {
                match self {
                    Self::Unknown => "DISPLAY_MODE_UNKNOWN",
                    Self::Always => "ALWAYS",
                    Self::Never => "NEVER",
                    Self::OnlyWhenAppIsOpen => "ONLY_WHEN_APP_IS_OPEN",
                }
            }
            /// Creates an enum from field names used in the ProtoBuf definition.
            pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
                match value {
                    "DISPLAY_MODE_UNKNOWN" => Some(Self::Unknown),
                    "ALWAYS" => Some(Self::Always),
                    "NEVER" => Some(Self::Never),
                    "ONLY_WHEN_APP_IS_OPEN" => Some(Self::OnlyWhenAppIsOpen),
                    _ => None,
                }
            }
        }
        ...
        pub enum SettingKey {
            ...
            MinimizeToTray = 2,
            Language = 3,
            ReplaceTextWithEmoji = 4,
            BannerNotificationDisplayMode = 5,
            UnreadCounterBadgeDisplayMode = 6,
            IsMessagesNotificationEnabled = 7,
            IsCallsNotificationEnabled = 8,
            IsReactionsNotificationEnabled = 9,
            IsStatusReactionsNotificationEnabled = 10,
            IsTextPreviewForNotificationEnabled = 11,
            DefaultNotificationToneId = 12,
            GroupDefaultNotificationToneId = 13,
            AppTheme = 14,
            WallpaperId = 15,
            IsDoodleWallpaperEnabled = 16,
            FontSize = 17,
            IsPhotosAutodownloadEnabled = 18,
            IsAudiosAutodownloadEnabled = 19,
            IsVideosAutodownloadEnabled = 20,
            IsDocumentsAutodownloadEnabled = 21,
            DisableLinkPreviews = 22,
            NotificationToneId = 23,
        }
        impl SettingKey {
            /// String value of the enum field names used in the ProtoBuf definition.
            ///
            ...
            pub fn as_str_name(&self) -> &'static str {
                match self {
                    Self::Unknown => "SETTING_KEY_UNKNOWN",
                    Self::StartAtLogin => "START_AT_LOGIN",
                    Self::MinimizeToTray => "MINIMIZE_TO_TRAY",
                    Self::Language => "LANGUAGE",
                    Self::ReplaceTextWithEmoji => "REPLACE_TEXT_WITH_EMOJI",
                    Self::BannerNotificationDisplayMode => "BANNER_NOTIFICATION_DISPLAY_MODE",
                    Self::UnreadCounterBadgeDisplayMode => "UNREAD_COUNTER_BADGE_DISPLAY_MODE",
                    Self::IsMessagesNotificationEnabled => "IS_MESSAGES_NOTIFICATION_ENABLED",
                    Self::IsCallsNotificationEnabled => "IS_CALLS_NOTIFICATION_ENABLED",
                    Self::IsReactionsNotificationEnabled => "IS_REACTIONS_NOTIFICATION_ENABLED",
                    Self::IsStatusReactionsNotificationEnabled => "IS_STATUS_REACTIONS_NOTIFICATION_ENABLED",
                    Self::IsTextPreviewForNotificationEnabled => "IS_TEXT_PREVIEW_FOR_NOTIFICATION_ENABLED",
                    Self::DefaultNotificationToneId => "DEFAULT_NOTIFICATION_TONE_ID",
                    Self::GroupDefaultNotificationToneId => "GROUP_DEFAULT_NOTIFICATION_TONE_ID",
                    Self::AppTheme => "APP_THEME",
                    Self::WallpaperId => "WALLPAPER_ID",
                    Self::IsDoodleWallpaperEnabled => "IS_DOODLE_WALLPAPER_ENABLED",
                    Self::FontSize => "FONT_SIZE",
                    Self::IsPhotosAutodownloadEnabled => "IS_PHOTOS_AUTODOWNLOAD_ENABLED",
                    Self::IsAudiosAutodownloadEnabled => "IS_AUDIOS_AUTODOWNLOAD_ENABLED",
                    Self::IsVideosAutodownloadEnabled => "IS_VIDEOS_AUTODOWNLOAD_ENABLED",
                    Self::IsDocumentsAutodownloadEnabled => "IS_DOCUMENTS_AUTODOWNLOAD_ENABLED",
                    Self::DisableLinkPreviews => "DISABLE_LINK_PREVIEWS",
                    Self::NotificationToneId => "NOTIFICATION_TONE_ID",
                }
            }
            /// Creates an enum from field names used in the ProtoBuf definition.
            pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
                match value {
                    "SETTING_KEY_UNKNOWN" => Some(Self::Unknown),
                    "START_AT_LOGIN" => Some(Self::StartAtLogin),
                    "MINIMIZE_TO_TRAY" => Some(Self::MinimizeToTray),
                    "LANGUAGE" => Some(Self::Language),
                    "REPLACE_TEXT_WITH_EMOJI" => Some(Self::ReplaceTextWithEmoji),
                    "BANNER_NOTIFICATION_DISPLAY_MODE" => Some(Self::BannerNotificationDisplayMode),
                    "UNREAD_COUNTER_BADGE_DISPLAY_MODE" => Some(Self::UnreadCounterBadgeDisplayMode),
                    "IS_MESSAGES_NOTIFICATION_ENABLED" => Some(Self::IsMessagesNotificationEnabled),
                    "IS_CALLS_NOTIFICATION_ENABLED" => Some(Self::IsCallsNotificationEnabled),
                    "IS_REACTIONS_NOTIFICATION_ENABLED" => Some(Self::IsReactionsNotificationEnabled),
                    "IS_STATUS_REACTIONS_NOTIFICATION_ENABLED" => Some(Self::IsStatusReactionsNotificationEnabled),
                    "IS_TEXT_PREVIEW_FOR_NOTIFICATION_ENABLED" => Some(Self::IsTextPreviewForNotificationEnabled),
                    "DEFAULT_NOTIFICATION_TONE_ID" => Some(Self::DefaultNotificationToneId),
                    "GROUP_DEFAULT_NOTIFICATION_TONE_ID" => Some(Self::GroupDefaultNotificationToneId),
                    "APP_THEME" => Some(Self::AppTheme),
                    "WALLPAPER_ID" => Some(Self::WallpaperId),
                    "IS_DOODLE_WALLPAPER_ENABLED" => Some(Self::IsDoodleWallpaperEnabled),
                    "FONT_SIZE" => Some(Self::FontSize),
                    "IS_PHOTOS_AUTODOWNLOAD_ENABLED" => Some(Self::IsPhotosAutodownloadEnabled),
                    "IS_AUDIOS_AUTODOWNLOAD_ENABLED" => Some(Self::IsAudiosAutodownloadEnabled),
                    "IS_VIDEOS_AUTODOWNLOAD_ENABLED" => Some(Self::IsVideosAutodownloadEnabled),
                    "IS_DOCUMENTS_AUTODOWNLOAD_ENABLED" => Some(Self::IsDocumentsAutodownloadEnabled),
                    "DISABLE_LINK_PREVIEWS" => Some(Self::DisableLinkPreviews),
                    "NOTIFICATION_TONE_ID" => Some(Self::NotificationToneId),
                    _ => None,
                }
            }
        }
        ...
        impl SettingPlatform {
            ...
            pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
                match value {
                    "PLATFORM_UNKNOWN" => Some(Self::PlatformUnknown),
                    "WEB" => Some(Self::Web),
...
pub struct WebMessageInfo {
    ...
    #[prost(message, optional, tag="74")]
    pub group_history_individual_message_info: ::core::option::Option<GroupHistoryIndividualMessageInfo>,
    #[prost(message, optional, tag="75")]
    pub group_history_bundle_info: ::core::option::Option<GroupHistoryBundleInfo>,
    #[prost(message, optional, tag="76")]
    pub interactive_message_additional_metadata: ::core::option::Option<InteractiveMessageAdditionalMetadata>,
    #[prost(message, optional, tag="77")]
...
pub mod web_message_info {
    ...
    pub enum StubType {
        ...
        GroupOpenBotAdded = 222,
        GroupTeeBotAdded = 223,
    }
    impl StubType {
        /// String value of the enum field names used in the ProtoBuf definition.
        ///
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::PhoneNumberHidingChatDeprecatedMessage => "PHONE_NUMBER_HIDING_CHAT_DEPRECATED_MESSAGE",
                Self::QuarantinedMessage => "QUARANTINED_MESSAGE",
                Self::GroupMemberShareGroupHistoryMode => "GROUP_MEMBER_SHARE_GROUP_HISTORY_MODE",
                Self::GroupOpenBotAdded => "GROUP_OPEN_BOT_ADDED",
                Self::GroupTeeBotAdded => "GROUP_TEE_BOT_ADDED",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "PHONE_NUMBER_HIDING_CHAT_DEPRECATED_MESSAGE" => Some(Self::PhoneNumberHidingChatDeprecatedMessage),
                "QUARANTINED_MESSAGE" => Some(Self::QuarantinedMessage),
                "GROUP_MEMBER_SHARE_GROUP_HISTORY_MODE" => Some(Self::GroupMemberShareGroupHistoryMode),
                "GROUP_OPEN_BOT_ADDED" => Some(Self::GroupOpenBotAdded),
                "GROUP_TEE_BOT_ADDED" => Some(Self::GroupTeeBotAdded),
                _ => None,
            }
        }
    }
...
pub enum BotMetricsEntryPoint {
    ...
    MediaPicker1On1Chat = 39,
    MediaPickerGroupChat = 40,
    AskMetaAiNoSearchResults = 41,
    MetaAiSettings = 45,
}
impl BotMetricsEntryPoint {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::MediaPicker1On1Chat => "MEDIA_PICKER_1_ON_1_CHAT",
            Self::MediaPickerGroupChat => "MEDIA_PICKER_GROUP_CHAT",
            Self::AskMetaAiNoSearchResults => "ASK_META_AI_NO_SEARCH_RESULTS",
            Self::MetaAiSettings => "META_AI_SETTINGS",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "MEDIA_PICKER_1_ON_1_CHAT" => Some(Self::MediaPicker1On1Chat),
            "MEDIA_PICKER_GROUP_CHAT" => Some(Self::MediaPickerGroupChat),
            "ASK_META_AI_NO_SEARCH_RESULTS" => Some(Self::AskMetaAiNoSearchResults),
            "META_AI_SETTINGS" => Some(Self::MetaAiSettings),
            _ => None,
        }
    }
}
...
impl BotSessionSource {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::Voice => "VOICE",
            Self::AiHomeSession => "AI_HOME_SESSION",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "VOICE" => Some(Self::Voice),
            "AI_HOME_SESSION" => Some(Self::AiHomeSession),
            _ => None,
        }
    }
}
...
pub enum MutationProps {
    ...
    SettingsSyncAction = 78,
    ShareOwnPn = 10001,
    BusinessBroadcastAction = 10002,
    AiThreadDeleteAction = 10003,
}
impl MutationProps {
    /// String value of the enum field names used in the ProtoBuf definition.
    ///
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::PrivacySettingDisableLinkPreviewsAction => "PRIVACY_SETTING_DISABLE_LINK_PREVIEWS_ACTION",
            ...
            Self::NotificationActivitySettingAction => "NOTIFICATION_ACTIVITY_SETTING_ACTION",
            Self::LidContactAction => "LID_CONTACT_ACTION",
            Self::CtwaPerCustomerDataSharingAction => "CTWA_PER_CUSTOMER_DATA_SHARING_ACTION",
            Self::PaymentTosAction => "PAYMENT_TOS_ACTION",
            Self::PrivacySettingChannelsPersonalisedRecommendationAction => "PRIVACY_SETTING_CHANNELS_PERSONALISED_RECOMMENDATION_ACTION",
            Self::BusinessBroadcastAssociationAction => "BUSINESS_BROADCAST_ASSOCIATION_ACTION",
            ...
            Self::StatusPostOptInNotificationPreferencesAction => "STATUS_POST_OPT_IN_NOTIFICATION_PREFERENCES_ACTION",
            ...
            Self::SettingsSyncAction => "SETTINGS_SYNC_ACTION",
            Self::ShareOwnPn => "SHARE_OWN_PN",
            Self::BusinessBroadcastAction => "BUSINESS_BROADCAST_ACTION",
            Self::AiThreadDeleteAction => "AI_THREAD_DELETE_ACTION",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "MARKETING_MESSAGE_BROADCAST_ACTION" => Some(Self::MarketingMessageBroadcastAction),
            ...
            "PRIVACY_SETTING_DISABLE_LINK_PREVIEWS_ACTION" => Some(Self::PrivacySettingDisableLinkPreviewsAction),
            ...
            "WAFFLE_ACCOUNT_LINK_STATE_ACTION" => Some(Self::WaffleAccountLinkStateAction),
            "USERNAME_CHAT_START_MODE" => Some(Self::UsernameChatStartMode),
            "NOTIFICATION_ACTIVITY_SETTING_ACTION" => Some(Self::NotificationActivitySettingAction),
            "LID_CONTACT_ACTION" => Some(Self::LidContactAction),
            "CTWA_PER_CUSTOMER_DATA_SHARING_ACTION" => Some(Self::CtwaPerCustomerDataSharingAction),
            "PAYMENT_TOS_ACTION" => Some(Self::PaymentTosAction),
            "PRIVACY_SETTING_CHANNELS_PERSONALISED_RECOMMENDATION_ACTION" => Some(Self::PrivacySettingChannelsPersonalisedRecommendationAction),
            "BUSINESS_BROADCAST_ASSOCIATION_ACTION" => Some(Self::BusinessBroadcastAssociationAction),
            "DETECTED_OUTCOMES_STATUS_ACTION" => Some(Self::DetectedOutcomesStatusAction),
            "MAIBA_AI_FEATURES_CONTROL_ACTION" => Some(Self::MaibaAiFeaturesControlAction),
            "BUSINESS_BROADCAST_LIST_ACTION" => Some(Self::BusinessBroadcastListAction),
            "MUSIC_USER_ID_ACTION" => Some(Self::MusicUserIdAction),
            "STATUS_POST_OPT_IN_NOTIFICATION_PREFERENCES_ACTION" => Some(Self::StatusPostOptInNotificationPreferencesAction),
            "AVATAR_UPDATED_ACTION" => Some(Self::AvatarUpdatedAction),
            "GALAXY_FLOW_ACTION" => Some(Self::GalaxyFlowAction),
            "PRIVATE_PROCESSING_SETTING_ACTION" => Some(Self::PrivateProcessingSettingAction),
            "NEWSLETTER_SAVED_INTERESTS_ACTION" => Some(Self::NewsletterSavedInterestsAction),
            "AI_THREAD_RENAME_ACTION" => Some(Self::AiThreadRenameAction),
            "INTERACTIVE_MESSAGE_ACTION" => Some(Self::InteractiveMessageAction),
            "SETTINGS_SYNC_ACTION" => Some(Self::SettingsSyncAction),
            "SHARE_OWN_PN" => Some(Self::ShareOwnPn),
            "BUSINESS_BROADCAST_ACTION" => Some(Self::BusinessBroadcastAction),
            "AI_THREAD_DELETE_ACTION" => Some(Self::AiThreadDeleteAction),
            _ => None,
        }
    }
}
